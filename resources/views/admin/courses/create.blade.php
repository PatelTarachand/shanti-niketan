                ...
                <form action="{{ route('admin.courses.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('description') is-invalid @enderror"
                                  ...
                                  placeholder="Brief description of the course" required>{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                        ...
                        <div class="col-md-3">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('total_semesters') is-invalid @enderror"
                                       id="total_semesters" name="total_semesters" value="{{ old('total_semesters') }}"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('fees_per_semester') is-invalid @enderror"
                                       id="fees_per_semester" name="fees_per_semester" value="{{ old('fees_per_semester') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('eligibility_criteria') is-invalid @enderror"
                                  ...
                                  placeholder="Enter criteria separated by commas (e.g., 12th with PCM, Minimum 60% marks, JEE Main qualified)">{{ old('eligibility_criteria') }}</textarea>
...
$(document).ready(function() {
    ...
    // Auto-set available seats to total seats initially
    $('#total_seats').change(function() {
        if (!$('#available_seats').val()) {
            $('#available_seats').val($(this).val());
        }
    });
});
</script>
